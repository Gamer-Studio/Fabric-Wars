...
namespace FabricWars.Utils.Extensions
{
    public static class VectorExtensions
    {
        ...
        public static Vector3 Add(this Vector3 vector, float x, float y, float z) => new(x + vector.x, y + vector.y, z + vector.z);
        public static Vector3 Multiply(this Vector3 vector, float x, float y, float z) => new(x * vector.x, y * vector.y, z * vector.z);
        public static Vector3 Abs(this Vector3 vector) => new(Math.Abs(vector.x), Math.Abs(vector.y), Math.Abs(vector.z));
        public static Vector3 Min(this Vector3 vector1, Vector3 vector2) => new(Math.Min(vector1.x, vector2.x), Math.Min(vector1.y, vector2.y), Math.Min(vector1.z, vector2.z));
        public static Vector3 Max(this Vector3 vector1, Vector3 vector2) => new(Math.Max(vector1.x, vector2.x), Math.Max(vector1.y, vector2.y), Math.Max(vector1.z, vector2.z));
        public static Vector3 Clamp(this Vector3 vector, Vector3 min, Vector3 max) => new(Math.Clamp(vector.x, min.x, max.x), Math.Clamp(vector.y, min.y, max.y), Math.Clamp(vector.z, min.z, max.z));
        public static Vector3 Clamp(this Vector3 vector, float min, float max) => new(Math.Clamp(vector.x, min, max), Math.Clamp(vector.y, min, max), Math.Clamp(vector.z, min, max));
        ...
        public static Vector2Int LerpUnclamped(this Vector2Int vector1, Vector2Int vector2, float amount) => new Vector2Int(
            (int)(vector1.x + (vector2.x - vector1.x) * amount),
            (int)(vector1.y + (vector2.y - vector1.y) * amount)
        );
        ...
        public static Vector3Int Add(this Vector3Int vector, int x, int y, int z) => new(x + vector.x, y + vector.y, vector.z + z);
        public static Vector3Int Multiply(this Vector3Int vector, int x, int y, int z) => new(x * vector.x, y * vector.y, z * vector.z);
        public static Vector3Int Abs(this Vector3Int vector) => new(Math.Abs(vector.x), Math.Abs(vector.y), Math.Abs(vector.z));
        public static Vector3Int Min(this Vector3Int vector1, Vector3Int vector2) => new(Math.Min(vector1.x, vector2.x), Math.Min(vector1.y, vector2.y), Math.Min(vector1.z, vector2.z));
        public static Vector3Int Max(this Vector3Int vector1, Vector3Int vector2) => new(Math.Max(vector1.x, vector2.x), Math.Max(vector1.y, vector2.y), Math.Max(vector1.z, vector2.z));
